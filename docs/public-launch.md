...
6. **Does BasketIndex include AI analysis?** — No. BasketIndex exports your data as structured JSON and CSV. You can use those exports with any analysis tool you choose (spreadsheet, ChatGPT, Claude, custom scripts). We provide a [downloadable prompt](docs/prompts/personal-inflation-analysis.md) as a starting point for personal inflation analysis, but BasketIndex itself does not perform AI analysis or make financial recommendations.
7. **Can I use BasketIndex to track inflation?** — BasketIndex exports can be used for personal inflation analysis (tracking price changes in your own shopping across time), but BasketIndex does not provide official inflation calculations, economic analysis, or financial advice. The data is yours — what you do with it is up to you.
